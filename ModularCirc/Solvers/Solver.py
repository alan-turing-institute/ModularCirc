...
from .JaxSolver import JaxSolver
...
class Solver():
    def __init__(self, model: OdeModel = None, solver: BaseSolver = None) -> None:
        self.model = model
        self.solver = solver if solver is not None else ScipySolver()
    ...
    def setup(self, optimize_secondary_sv: bool = False, suppress_output: bool = False, step_tol: float = 1e-2,
              conv_cols: list = None, method: str = 'BDF', atol=1e-6, rtol=1e-6) -> None:
