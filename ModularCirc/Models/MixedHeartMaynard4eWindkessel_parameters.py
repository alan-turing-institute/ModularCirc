...
class MixedHeartMaynard4eWindkessel_parameters(ParametersObject):
   ...
   Model Parameters for MixedHeartMaynard4eWindkessel models
    ...
    def __init__(self, name='MixedHeartMaynard4eWindkessel_parameters') -> None:
        ...
        self.set_chamber_comp('lv', E_pas= 0.1,  E_act= 2.5,  v_ref=5.0, k_pas=0.03, tr = 0.30,  td = 0.450,              v=50.)
        self.set_chamber_comp('la', E_pas= 0.15, E_act= 0.25, v_ref=4.0, k_pas=0.03, tpwb = 0.0, tpww = 0.09, delay=0.08, v=0.0)
        self.set_chamber_comp('rv', E_pas= 0.1,  E_act= 1.15, v_ref=10., k_pas=0.03, tr =0.30,   td=0.45,                 v=100.)
        self.set_chamber_comp('ra', E_pas= 0.15, E_act= 0.25, v_ref=4.,  k_pas=0.03, tpwb=0.0,   tpww=0.09,   delay=0.08, v=0.0)
        ...
        self.set_rlc_comp('pa', r=(0.01+0.05+0.25), c=3.8 , l=0.0017  , v=200.0, v_ref=0.0)
